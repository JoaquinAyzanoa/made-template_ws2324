...
class DataPipeline:
    ...
    def create_sqldb(self, dtype_mapping):
        ...
        #save the sqlite file path
        db_dir = os.path.join(f"./data/{self._db_name}.sqlite")
        return db_dir
...
def create_db_1():
    ...
    df = dp_1.del_missing_info('Vehicles', "-")
    dtype_mapping_sql = {
        'PC': sql.types.String, 
    ...
    db_dir = dp_1.create_sqldb(dtype_mapping_sql)
    return df, db_dir
...
def create_db_2():
    ...
    df = dp_2.replace_str(['---','--','nan'], np.nan)
    ...
    db_dir = dp_2.create_sqldb(dtype_mapping2_sql)
    return df, db_dir
...
if __name__ == '__main__':
    ...
    db_name_1 = 'vehicles'
    table_name_1 = 'vehicles'
    df1, db_dir1 = create_db_1()
    #Datasourse 2: AirPollution
    db_name_2 = 'airpollution'
    table_name_2 = 'airpollution'
    df2, db_dir2 = create_db_2()

#This comment was added to test Github Actions.